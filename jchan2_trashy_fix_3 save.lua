...
gui.text(32 + p*168,40,string.format("Player x value: %d", px))
...
--Attack
	if p == 0 then
		...
		print(32 + p*168,32,string.format("DamageBase: %d",dmgbase))
		print(32 + p*168,40,string.format("Dmgfinal: %d",damagef))
